import type {SceneManager} from "../view/SceneManager";
...
export class Convergence implements IConvergence {
	...
	private readonly _originalAnimationDuration: number; // ms
	private _hasChanged: boolean = false;
	private _prevDeltaValue: number = 0;
	private _prevTimeStamp: number = 1;
	private _prevDeltaTime: number = 1;
	private readonly _easing: Easing = Easing.EASE_OUT;
	private _timeoutId: number = -1;
	private readonly _triggerRender: boolean;
