...
export class SceneManager {
	...
	public switchToTask(selectedTask: Task) {
		this._activeTask.disable();
		this._activeTask = selectedTask;
		this._activeTask.enable();
	...
	private readonly onContextLost = async (event: Event) => {
