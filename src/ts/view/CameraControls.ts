...
export class CameraControls {
	...
	private readonly _triggerClickThreshold: {
		deltaCursor: number;
		deltaTime: number;
	} = {
		deltaCursor: 3,
	...
	private readonly _u: BoundedConvergence;
	private readonly _v: BoundedConvergence;
	private readonly _pinch: {
		startValue: {
	...
	private _cameraNormalizedPosition: number[] = VectorUtils.normalize([0, 0.3, 1]);
